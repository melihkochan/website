    ...
    <div className={styles.browser} onClick={(e) => e.stopPropagation()}>
      <div className={styles.toolbar}>
        <div className={styles.tabBar}>
          <div className={styles.tab}>
            ...
            <span className={styles.tabTitle}>Mail - melihkochan@gmail.com</span>
      ...
      <div className={styles.addressBar}>
        ...
        <div className={styles.urlBar}>
          ...
          <span className={styles.urlText}>mailto:melihkochan00@gmail.com</span>
        </div>
      ...
      <div ref={browserContentRef} className={styles.browserContent}>
        {isLoading ? (
          ...
          <div className={styles.externalSitePrompt}>
            ...
            <h2 className={styles.externalSiteTitle}>E-posta Gönder</h2>
            <p className={styles.externalSiteDescription}>
              Varsayılan e-posta istemcinizi açıp melihkochan00@gmail.com adresine e-posta göndermek için aşağıdaki butona tıklayın
            </p>
            <a
